    ...
    public partial class MainForm : Form
    {
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(numberTextBox.Text))
            {
                ...
                MessageBox.Show("Please input a phone number first. Make sure to include the country code (i.e.: +1) and use no spaces.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            sendSMS = true;
        }
